...
public class DateUtils {
     ...
     * @return The number of days between start and end, if end is after start, returns a positive number, otherwise
    ...
    /**
     * Acquire LocalDateTime Millis long.
     *
     * @param localDateTime the time
     * @return the long
     */
    public static long acquireMillisBetween(final LocalDateTime localDateTime) {
