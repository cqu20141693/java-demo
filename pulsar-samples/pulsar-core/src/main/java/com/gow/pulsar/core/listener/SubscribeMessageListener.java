        ...
        if (genericParameterTypes.length == 2) {
            ...
            if (genericParameterTypes[0] instanceof ParameterizedType) {
                ...
                if (genericParameterType.getRawType() == Message.class) {
                    ...
                    PulsarLog.log.warn("pulsar subscribe bean={} targetMethod={} parameter error", bean.getClass(),
            ...
            PulsarLog.log.error("bean={} targetMethod={} parameter error", bean.getClass(), targetMethod.getName());
        }
    }
