...
public interface InfluxDB extends AutoCloseable {
   ...
   */
  public static final String LOG_LEVEL_PROPERTY = "org.InfluxDB.logLevel";
  ...
  InfluxDB enableBatch(int actions, int flushDuration, TimeUnit flushDurationTimeUnit,
                       ThreadFactory threadFactory, BiConsumer<BatchPoints, Throwable> exceptionHandler,
  ...
  *           the udpPort where influxdb is listening
   ...
   * @deprecated (since 2.9, removed in 3.0) Use <code>org.InfluxDB.query(Query)</code>
