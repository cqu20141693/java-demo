...
public final class BatchProcessor {
  ...
  private final BiConsumer<BatchPoints, Throwable> exceptionHandler;
  ...
  public static final class Builder {
    ...
    private BiConsumer<BatchPoints, Throwable> exceptionHandler = (batchPoints, throwable) -> { };
     ...
     * @return this Builder to use it fluent
     */
    public Builder exceptionHandler(final BiConsumer<BatchPoints, Throwable> handler) {
  ...
  BatchProcessor(final InfluxDBImpl influxDB, final BatchWriter batchWriter, final ThreadFactory threadFactory,
                 ...
                 final BiConsumer<BatchPoints, Throwable> exceptionHandler,
