...
public final class BatchOptions implements Cloneable {
  ...
  BiConsumer<BatchPoints, Throwable> exceptionHandler = (points, throwable) -> {
  };
   ...
   * @return the BatchOptions instance to be able to use it in a fluent manner.
   */
  public BatchOptions exceptionHandler(final BiConsumer<BatchPoints, Throwable> exceptionHandler) {
    BatchOptions clone = getClone();
   ...
   */
  public BiConsumer<BatchPoints, Throwable> getExceptionHandler() {
