...
import com.cc.gb28181.entity.MediaChannelEntity;
import com.cc.gb28181.media.enums.ChannelStatus;
import com.cc.gb28181.media.enums.PTZType;
...
public class GB28181DeviceChannel {
    ...
    public MediaChannelEntity toEntity() {
        MediaChannelEntity entity = new MediaChannelEntity();
        // copy(this, entity);
        entity.with(this);
        return entity;
    }
    ...
    public static class Info {
        ...
        public String toXML() {
            ...
            joiner
                    ...
                    .add("</PTZType>\n");
            joiner.add("<DownloadSpeed>").add(XmlUtils.safeString(downloadSpeed)).add("</DownloadSpeed>\n");
