...
class SessionDescriptionImpl implements SessionDescription {
    ...
    protected Vector<ZoneAdjustment> zoneAdjustments;
    ...
    public SessionDescriptionImpl(SessionDescription otherSessionDescription)
        ...
        if (otherMediaDescriptions != null) {
            ...
            this.ssrc = otherSessionDescription.getSsrc();
            this.audioDesc = otherSessionDescription.getAudioDesc();
    ...
    public void addField(SDPField sdpField) throws ParseException {
        try {
            ...
            } else if (sdpField instanceof Ssrc) {
                this.ssrc = ((Ssrc) sdpField);
            } else if (sdpField instanceof AudioDesc) {
                this.audioDesc = ((AudioDesc) sdpField);
            }
    ...
    public String toString() {
        ...
        try {
            ...
            encBuff.append(getSsrc() == null ? ""
                    : getSsrc().toString());

            encBuff.append(getAudioDesc() == null ? ""
                    : getAudioDesc().toString());
            // adds the final crlf
