...
import com.cc.gb28181.ssrc.AudioDesc;
import com.cc.gb28181.ssrc.Ssrc;
...
public interface SessionDescription extends Serializable, Cloneable {
    ...
    @SneakyThrows
    static SessionDescription parse(String content) {
        return new SDPAnnounceParser(content).parse();
    }
     ...
     * @throws SdpException
     */
    Vector<Email> getEmails(boolean create)
     ...
     * @throws SdpException
     */
    Vector<Phone> getPhones(boolean create)
            throws SdpException;
     ...
     * @throws SdpException if the vector is null
     */
    void setPhones(Vector<Phone> phones)
            throws SdpException;
     ...
     * @throws SdpException
     */
    Vector<TimeDescription> getTimeDescriptions(boolean create)
            throws SdpException;
     ...
     * @throws SdpException if the vector is null
     */
    void setTimeDescriptions(Vector<TimeDescription> times)
            throws SdpException;
     ...
     * @throws SdpException
     */
    Vector<ZoneAdjustment> getZoneAdjustments(boolean create)
            throws SdpException;
     ...
     * @throws SdpException if the vector is null
     */
    void setZoneAdjustments(Vector<ZoneAdjustment> zoneAdjustments)
            throws SdpException;
     ...
     */
    Vector<BandWidth> getBandwidths(boolean create);
     ...
     * @throws SdpException if the vector is null
     */
    void setBandwidths(Vector<BandWidth> bandwidths)
            throws SdpException;
    ...
    default Optional<String> getAttributeOptional(String name) {
        try {
     ...
     */
    Vector<Attribute> getAttributes(boolean create);
     ...
     * @throws SdpException
     */
    Vector<MediaDescription> getMediaDescriptions(boolean create)
            throws SdpException;
     ...
     * @throws SdpException if the parameter is null
     */
    void setMediaDescriptions(Vector<MediaDescription> mediaDescriptions)
            throws SdpException;
