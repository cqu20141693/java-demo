...
import com.cc.ocpp.network.cp.domian.heart.GunData;
import com.cc.ocpp.network.cp.domian.heart.PingMessage;
...
public class Utils {
    ...
    public static CPMessage getDefaultPing(int i) {
        String gun_attached_car = "7E 00 03 00 26 00 01 01 01 02 13 00 26 00 00 00 00 00 00 00 00 01 01 01 00 00 00 00 80 00 00 00 03 08 A2 00 00 00 00 00 06 1A 80 00 06 1A 80 00 06 1A 80 B4 7E";
        String idle = "7E 00 03 00 26 00 01 01 01 02 13 00 26 00 00 00 00 00 00 00 00 01 01 01 00 00 00 00 80 00 00 00 00 08 A2 00 00 00 00 00 06 1A 80 00 06 1A 80 00 06 1A 80 B4 7E";
        String charging = "7E 00 03 00 26 00 01 01 01 02 13 00 26 00 00 00 00 00 00 00 00 01 01 01 00 00 00 00 80 00 00 00 05 08 A2 00 00 00 00 00 06 1A 80 00 06 1A 80 00 06 1A 80 B4 7E";

        DecodeContext cpMessage ;
        if(i==0){
            cpMessage= getCPMessage(gun_attached_car);
        } else if(i==1){
           cpMessage= getCPMessage(charging);
        }else {
            cpMessage=getCPMessage(idle);
        }
