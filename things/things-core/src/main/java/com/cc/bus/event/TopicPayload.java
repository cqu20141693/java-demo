...
import com.cc.things.codec.RecyclerUtils;
...
public class TopicPayload implements Payload {
    public static boolean POOL_ENABLED = Boolean.parseBoolean(System.getProperty("wcc.eventbus.payload.pool.enabled", "true"));
