...
import com.cc.things.metadata.UnitSupported;
...
public abstract class NumberType<N extends Number> extends AbstractType<NumberType<N>> implements UnitSupported, DataType, Converter<N> {
    ...
    static boolean ORIGINAL = Boolean.parseBoolean(System.getProperty("wcc.type.number.convert.original", "true"));
    ...
    protected RoundingMode defaultRound() {
        return RoundingMode.valueOf(System.getProperty("wcc.type." + getType() + ".round", "HALF_UP"));
    }
