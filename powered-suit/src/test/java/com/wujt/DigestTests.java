...
import com.wujt.digest.DigestUtil;
...
public class DigestTests {
    ...
    @Test
    public void testMD2() {
        DigestUtil md2 = new DigestUtil(DigestUtil.Algorithm.MD2);
        Assert.assertEquals("4227ce10dca49dd2d0ba3f438d1ea9f3", md2.getHex("HelloWorld"));
        Assert.assertEquals("6bb5d0d379bf84eb4a99258abd8d8111", md2.getHex("TakWolf"));
        Assert.assertEquals("ef4cce74dab86220df3d2cde2bf7872d", md2.getHex("Google"));
        Assert.assertEquals("6b961156ddca01ab3310afaa7872dc11", md2.getHex("今天的风儿有点喧嚣"));
        Assert.assertEquals("3d8741f5dae947e6b5ccb060f6b8e2e0", md2.getHex("おはよう"));
        Assert.assertEquals("6b35e13142b337b4d19d68cb2ea97097", md2.getHex("http://takwolf.com"));
    }

    @Test
    public void testMD5() {
        DigestUtil md5 = new DigestUtil(DigestUtil.Algorithm.MD5);
    ...
    public void testSHA1() {
        DigestUtil sha1 = new DigestUtil(DigestUtil.Algorithm.SHA1);
        Assert.assertEquals("db8ac1c259eb89d4a131b253bacfca5f319d54f2", sha1.getHex("HelloWorld"));
        Assert.assertEquals("3593f7c4e0bb6d84acf4c9dc50422c1b9627db30", sha1.getHex("TakWolf"));
        Assert.assertEquals("2b681c0a24baff8899d7163cc7f805c75e1f44e4", sha1.getHex("Google"));
        Assert.assertEquals("05582d7d60b3b1d56c15751bce30294792d563bc", sha1.getHex("今天的风儿有点喧嚣"));
        Assert.assertEquals("2d6e22246673b8bc06371e5d2cb922676fbe288a", sha1.getHex("おはよう"));
        Assert.assertEquals("6e5f8016c6bc2639b367caa210d65a2e3f668e0e", sha1.getHex("http://takwolf.com"));
    }

    @Test
    public void testSHA224() {
        DigestUtil sha224 = new DigestUtil(DigestUtil.Algorithm.SHA224);
        Assert.assertEquals("b07a0b24d54879214f2361e0a1ac320442fa4e53a0f607d126fbfb8a", sha224.getHex("HelloWorld"));
        Assert.assertEquals("c36d99bf1993e3174345fc067072b81efc6a18e8c4fc0a10641f8b42", sha224.getHex("TakWolf"));
        Assert.assertEquals("b84e52794c142b49fe92323cc27a68fc89b67ee05f6941120e8ac020", sha224.getHex("Google"));
        Assert.assertEquals("e6e5afe5fbfec476152a97581ebc6a671b3c8b20cfccc32fb8887b37", sha224.getHex("今天的风儿有点喧嚣"));
        Assert.assertEquals("979c3f609c2e16b25758fb6e483886b4e7b4073a2c62dc0f22144350", sha224.getHex("おはよう"));
        Assert.assertEquals("ae123552aec10e7be26eabad4ca5f11faa52346ac633d9aff19d1671", sha224.getHex("http://takwolf.com"));
    }

    @Test
    public void testSHA256() {
        DigestUtil sha256 = new DigestUtil(DigestUtil.Algorithm.SHA256);
    ...
    public void testSHA384() {
        DigestUtil sha384 = new DigestUtil(DigestUtil.Algorithm.SHA384);
    ...
    public void testSHA512() {
        DigestUtil sha512 = new DigestUtil(DigestUtil.Algorithm.SHA512);
