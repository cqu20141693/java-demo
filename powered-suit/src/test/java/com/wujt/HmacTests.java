...
import com.wujt.digest.HmacUtil;
...
public class HmacTests {
    ...
    @Test
    public void testMD5() {
        HmacUtil hmacMd5 = new HmacUtil(HmacUtil.Algorithm.MD5);
    ...
    public void testSHA1() {
        HmacUtil hmacSha1 = new HmacUtil(HmacUtil.Algorithm.SHA1);
    ...
    public void testSHA224() {
        HmacUtil hmacSha224 = new HmacUtil(HmacUtil.Algorithm.SHA224);
    ...
    public void testSHA256() {
        HmacUtil hmacSha256 = new HmacUtil(HmacUtil.Algorithm.SHA256);
    ...
    public void testSHA384() {
        HmacUtil hmacSha384 = new HmacUtil(HmacUtil.Algorithm.SHA384);
    ...
    public void testSHA512() {
        HmacUtil hmacSha512 = new HmacUtil(HmacUtil.Algorithm.SHA512);
